...
Board pinouts come from the vendor's own pinmap, not from guesswork — for the Core2 for AWS that is <https://docs.m5stack.com/en/core/core2_for_aws>. On that board LCD/TF take G38/G23/G18/G5/G15/G4, I2C (touch, RTC, IMU) G21/G22 with touch INT on G39, audio G12/G0/G2/G34, the SK6812 bar G25, and Port A G32/G33. Port B (G26/G36) and Port C (G13/G14, already the GPS UART here) are **not on the core unit** — they come with the optional M5GO-Bottom For AWS base, so a feature that assumes them is unreachable on a bare board. That leaves only **G19/G27** as free M-Bus GPIO, which is where the comm UART goes.
